...
#include "tools/dgoods_utility.hpp"
...
CONTRACT dgoods: public contract {
    public:
        ...
        TABLE [[eosio::contract("main_contract")]] lockednfts {
            uint64_t dgood_id;
        ...
        TABLE [[eosio::contract("main_contract")]] asks {
            uint64_t batch_id;
        ...
        TABLE [[eosio::contract("main_contract")]] tokenconfigs {
            name standard;
            string version;
            symbol_code symbol;
        ...
        TABLE [[eosio::contract("main_contract")]] categoryinfo {
            name category;
        ...
        TABLE [[eosio::contract("main_contract")]] dgoodstats {
            bool           fungible;
            bool           burnable;
            bool           sellable;
            bool           transferable;
        ...
        // scope is self
        TABLE [[eosio::contract("main_contract")]] dgood {
            uint64_t id;
        ...
        // scope is owner
        TABLE [[eosio::contract("main_contract")]] accounts {
            uint64_t category_name_id;
            name category;
            name token_name;
            asset amount;
